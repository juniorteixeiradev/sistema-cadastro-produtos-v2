...
const Dashboard = () => {
  const options = {
    ...
    grid: {
      ...
      borderColor: "#e0e0e0", // Specify grid line color
      strokeDashArray: 4,
      padding: {
        left: 2,
        right: 2,
  ...
  return (
    <div className="max-w-sm w-full bg-white rounded-lg shadow p-4 md:p-6">
      <div className="flex justify-between">
        <div>
          <h5 className="leading-none text-3xl font-bold text-gray-900 pb-2">R$12,423</h5>
          <p className="text-base font-normal text-gray-500">Vendas nessa Semana</p>
        </div>
      ...
      <div className="grid grid-cols-1 items-center border-t justify-between mt-5">
        {/* ... Dropdown content */}
      </div>
    </div>
  );
